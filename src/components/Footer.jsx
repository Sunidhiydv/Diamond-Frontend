...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-t from-black via-black/80 to-transparent py-12 text-white">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="mt-12 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} PN SHAH Diamonds. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
